...
* Maximum words: 291
* Minimum words: 105\
* Average tokens: 386.3
* Maximum tokens: 661
* Minimum tokens: 184\
* Entries with over 512 tokens: 16/210, 7.62%
...
* Total links: 4.79
* Unique links: 0.58
* Max links per tag, word: 0.48, 0.48
* Linked tags, words: 3.29, 3.29
* Linked % tags, words: 13.86%, 1.57%
* Avg links per tag, word: 0.34, 0.34


## Schema

* Maximums (B, I, E, S): 16, 28, 16, 21
* Averages (B, I, E, S): 4.12, 4.28, 4.12, 3.8
...
* Perturbing_Action: 1386, 48, 6.6
* Context: 1251, 28, 5.96
* Effect: 337, 11, 1.6
* Phenotype: 454, 12, 2.16

### Perturbing_Action

* Gene Loss-Of-Function: 543, 18, 2.59
* Gene Gain-Of-Function: 193, 24, 0.92
* Rnai/Knockdown: 164, 20, 0.78
* Pharmacological Inhibition: 245, 20, 1.17
* Pharmacological Augmentation: 62, 15, 0.3
* Other: 179, 15, 0.85
...
* Patient: 4, 3, 0.02
* Organism: 171, 9, 0.81
* Tissue/Organ: 60, 5, 0.29
* Neoplasm: 150, 11, 0.71
* Graft: 0, 0, 0.0
* Xenograft: 50, 7, 0.24
* Cells: 348, 14, 1.66
* Transformed Cells: 285, 14, 1.36
* Organoid: 25, 6, 0.12
* In Vitro: 68, 4, 0.32
* In Vivo: 90, 4, 0.43
...
* Anoikis: 1, 1, 0.0
* Autophagy: 99, 5, 0.47
* Cell Cycle Arrest: 10, 4, 0.05
* Cell Death: 10, 2, 0.05
* Cell Growth: 13, 4, 0.06
* Cell Survival: 5, 2, 0.02
* Colony Formation: 4, 2, 0.02
* Differentiation: 18, 2, 0.09
* Entosis: 0, 0, 0.0
* Epithelial-Mesenchymal Transition: 10, 4, 0.05
* Ferroptosis: 17, 8, 0.08
* Invasion: 7, 2, 0.03
* Metastasis: 51, 8, 0.24
* Migration: 14, 2, 0.07
* Mitophagy: 8, 2, 0.04
* Necroptosis: 0, 0, 0.0
* Necrosis: 3, 1, 0.01
* Oncosis: 0, 0, 0.0
* Proliferation: 36, 3, 0.17
* Pyroptosis: 0, 0, 0.0
* Quiescence: 2, 2, 0.01
* Self-Renewal: 6, 3, 0.03
* Senescence: 12, 3, 0.06
* Transformation: 7, 2, 0.03
* Tumour Growth: 43, 5, 0.2
* Tumourigenesis: 30, 6, 0.14
* Tumour Initiation: 4, 4, 0.02
* Tumour Progression: 6, 2, 0.03
* Tumour Regression: 15, 5, 0.07
